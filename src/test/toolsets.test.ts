...
const expectedOptInToolsets = ["activity", "administration", "site_settings", "webhooks", "themes", "groups", "moderation", "workflows", "ai_agents", "ai_custom_tools", "ai_features", "analytics", "ai_insights"];
